...
app.get('/ui/download(1).png', function (req, res) {
  res.sendFile(path.join(__dirname, 'ui', 'download(1).png'));
});
...
app.get('/ui/sun.png', function (req, res) {
  res.sendFile(path.join(__dirname, 'ui', 'sun.png'));
});
